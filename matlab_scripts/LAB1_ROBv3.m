...
for i = 1:length(time)
    ...
    alphak = (w_data_1_filtered(i) + sin(alpha) * tan(beta) * w_data_2_filtered(i) + cos(alpha) * tan(beta) * w_data_3_filtered(i));
    betak =  (cos(alpha) * w_data_2_filtered(i) - sin(alpha) * w_data_3_filtered(i));
    lambdak = ((sin(alpha) / cos(beta)) * w_data_2_filtered(i) + (cos(alpha) / cos(beta)) * w_data_3_filtered(i));
